  ...
  module Patches
    module IssuesControllerPatch
      def self.included(base)
        ...
        base.class_eval do
          prepend_before_action :find_issue_and_project, :only => [:helpdesk, :update_helpdesk_form]
        end
      end
      module ClassMethods
      end
      ...
      module InstanceMethods
        def helpdesk
          ...
          @issue.tracker ||=  @helpdesk_project.trackers.find((params[:issue] && params[:issue][:tracker_id]) || params[:tracker_id] || :first)
